...
| envDnsZoneRG | Name of the Azure Resource group which holds the Azure DNS Zone for your custom domain. | mydns-rg |
| envDomainName | Name of the Azure DNS Zone. | example.com |
